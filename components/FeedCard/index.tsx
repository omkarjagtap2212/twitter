        ...
        <div className='border border-gray-600 border-r-0 border-l-0  border-b-0  p-5  hover:bg-[#181818]  cursor-pointer transition-all'>
            <div className='grid grid-cols-12 gap-3 '>
                <div className='col-span-1'>
                    <Image className='rounded-full' src="https://media.licdn.com/dms/image/D4D35AQEMotckAv_0Pw/profile-framedphoto-shrink_400_400/0/1702315846874?e=1704312000&v=beta&t=BP1gda0qVG_WiTua1lMJNcKCXb8zXuPIcGFBfm5hd2w" alt="userPic" height={50} width={50} />
                </div>
