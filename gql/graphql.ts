...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser?: { __typename?: 'User', id: string, profileImage?: string | null, email: string, firstName: string, lastName?: string | null } | null };
